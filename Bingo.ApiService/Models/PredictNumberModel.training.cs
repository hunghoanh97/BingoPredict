...
namespace Bingo_ApiService
{
    public partial class PredictNumberModel
    {
        public const string RetrainFilePath =  @"C:\Users\hqhung4\Downloads\BingoData.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.ReplaceMissingValues(@"Winning Result", @"Winning Result")      
                                    .Append(mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"Draw Time",outputColumnName:@"Draw Time"))      
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"Winning Result",@"Draw Time"}))      
                                    .Append(mlContext.Regression.Trainers.FastForest(new FastForestRegressionTrainer.Options(){NumberOfTrees=17,NumberOfLeaves=5,FeatureFraction=0.79728526F,LabelColumnName=@"Sum",FeatureColumnName=@"Features"}));
